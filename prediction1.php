...
<section class="symptom">            
        <div class="s1head">
            ...
            <h2 class="heading-2">Select Your Symptoms Here</h2>
        </div>
            <div class="container">
...
<?php  
    if(isset($_POST['submit'])){
            $prediction = new Code;
            $prediction->prediction($_SESSION['user_id']);
            $symptoms1 = array("Runny or stuffy nose", "Sore or scratchy throat", "Sneezing", "Hoarse voice");
                ...
                // }else{
                //     $prediction->prediction($_SESSION['user_id']);
                //         echo "<p class='alert alert-success'>Symptoms Doesn't Inserted!</p>";
                // }     
...
?>                        
                         <form action="" method="POST">
                            ...
                            <label class="form-check-label fw-bold me-4" id="cold"><i class="fa-regular fa-snowflake"></i></label>
                            <input type="checkbox" name="symptoms1[]" class="in1 me-1" value="Runny or stuffy nose"><label class="me-4">Runny or stuffy nose</label>
                            <input type="checkbox" name="symptoms1[]" class="in1 me-1" value="Sore or scratchy throat"><label class="me-4">Sore or scratchy throat</label>
                            <input type="checkbox" name="symptoms1[]" class="in1 me-1" value="Sneezing"><label class="me-4">Sneezing</label>
                            <input type="checkbox" name="symptoms1[]" class="in1 me-1" value="Hoarse voice"><label class="me-4">Hoarse voice</label>
                            </div>
                            ...
                            <input type="checkbox" name="symptoms1[]" class="in1 me-1" value="Feeling unwell"><label class="me-4">Feeling unwell</label>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-mask-face"></i></label>
                            <input type="checkbox" name="symptoms2[]" class="in1 me-1" value="Persistent cough"><label class="me-4">Persistent cough</label>
                            <input type="checkbox" name="symptoms2[]" class="in1 me-1" value="Wheezing"><label class="me-4">Wheezing</label>
                            <input type="checkbox" name="symptoms2[]" class="in1 me-1" value="Difficulty breathing"><label class="me-4">Difficulty breathing</label>
                            <input type="checkbox" name="symptoms2[]" class="in1 me-1" value="Chest tightness"><label class="me-4">Chest tightness</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-syringe"></i></label>
                            <input type="checkbox" name="symptoms3[]" class="in1 me-1" value="Urinate a lot, often at night"><label class="me-4">Urinate a lot, often at night</label>
                            <input type="checkbox" name="symptoms3[]" class="in1 me-1" value="Always very thirsty"><label class="me-4">Always very thirsty</label>
                            <input type="checkbox" name="symptoms3[]" class="in1 me-1" value="Have blurry vision"><label class="me-4">Have blurry vision</label>
                            <input type="checkbox" name="symptoms3[]" class="in1 me-1" value="126 mg/dL (7 mmol/L) or higher"><label class="me-4">126 mg/dL (7 mmol/L) or higher suger level</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-virus-covid"></i></label>
                            <input type="checkbox" name="symptoms4[]" class="in1 me-1" value="Runny or stuffy nose"><label class="me-4"> Itchy skin or a raised rash (hives)</label>
                            <input type="checkbox" name="symptoms4[]" class="in1 me-1" value="Feeling unwell"><label class="me-4">Runny nose or sneezing</label>
                            <input type="checkbox" name="symptoms4[]" class="in1 me-1" value="Sore or scratchy throat"><label class="me-4">Pain/tenderness around cheeks</label>
                            <input type="checkbox" name="symptoms4[]" class="in1 me-1" value="Sneezing"><label class="me-4">Eyes/forehead ache</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-vial-virus"></i></label>
                            <input type="checkbox" name="symptoms5[]" class="in1 me-1" value="Pain / bloating in the belly area"><label class="me-4">Pain / bloating in the belly area</label>
                            <input type="checkbox" name="symptoms5[]" class="in1 me-1" value="Dark urine & pale stools"><label class="me-4">Dark urine & pale stools</label>
                            <input type="checkbox" name="symptoms5[]" class="in1 me-1" value="Fatigue"><label class="me-4">Fatigue</label>
                            <input type="checkbox" name="symptoms5[]" class="in1 me-1" value="Itching"><label class="me-4">Itching</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-shield-virus"></i></label>
                            <input type="checkbox" name="symptoms6[]" class="in1 me-1" value="Feeling feverish/ Fever"><label class="me-4">Feeling feverish/ Fever</label>
                            <input type="checkbox" name="symptoms6[]" class="in1 me-1" value="Cough"><label class="me-4">Cough</label>
                            <input type="checkbox" name="symptoms6[]" class="in1 me-1" value="Sore or scratchy throat"><label class="me-4">Sore or scratchy throat</label>
                            <input type="checkbox" name="symptoms6[]" class="in1 me-1" value="Runny or stuffy nose"><label class="me-4">Runny or stuffy nose</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-heart-pulse"></i></label>
                            <input type="checkbox" name="symptoms7[]" class="in1 me-1" value="Chest pain"><label class="me-4">Chest pain</label>
                            <input type="checkbox" name="symptoms7[]" class="in1 me-1" value="Shortness of Breath"><label class="me-4">Shortness of Breath</label>
                            <input type="checkbox" name="symptoms7[]" class="in1 me-1" value="Pain: neck, jaw, throat, upper belly, back"><label class="me-4">Pain: neck, jaw, throat, upper belly, back</label>
                            <input type="checkbox" name="symptoms7[]" class="in1 me-1" value="Swelling: In the legs, ankles, or feet"><label class="me-4">Swelling: In the legs, ankles, or feet</label>
                            ...
                            <div class="input-group mb-3">
                            <label class="form-check-label fw-bold me-4"><i class="fa-solid fa-lungs"></i></label>
                            <input type="checkbox" name="symptoms8[]" class="in1 me-1" value="Nasal discharge"><label class="me-4">Nasal discharge</label>
                            <input type="checkbox" name="symptoms8[]" class="in1 me-1" value="Nasal congestion"><label class="me-4">Nasal congestion</label>
                            <input type="checkbox" name="symptoms8[]" class="in1 me-1" value="Facial pain"><label class="me-4">Facial pain</label>
                            <input type="checkbox" name="symptoms8[]" class="in1 me-1" value="Postnasal drip"><label class="me-4">Postnasal drip</label>
                            </div>
