              ...
              <div class="carousel-inner">
                <div class="carousel-item active banner-img1">
                  <div class="carousel-caption d-none d-md-block">
                    <h1>The perfect place for your <br> Health Care</h1>
                    <p>Lorem ipsum dlior sit amet, consectetur adipis elit.<br>Consequatur natus repelendus facilis excepturi iste.</p>
                    <button type="button" class="btn btn-light text-primary ms-4">Book Now</button>
                  </div>
                </div>
                <div class="carousel-item banner-img2">
                  <div class="carousel-caption d-none d-md-block">
                    <h1>The perfect solution for your <br> disease prediction</h1>
                    <p>Lorem ipsum dlior sit amet, consectetur adipis elit.<br>Consequatur natus repellendus facilis excepturi iste.</p>
                    <button type="button" class="btn btn-light text-primary ms-4">Book Now</button>
                  </div>
                </div>
                <div class="carousel-item banner-img3">
                  <div class="carousel-caption d-none d-md-block">
                    <h1>The perfect opportunity for <br> medical survice</h1>
                    <p>Lorem ipsum dlior sit amet, consectetur adipis elit.<br>Consequatur natus repellendus facilis excepturi iste.</p>
                    <button type="button" class="btn btn-light text-primary ms-4">Book Now</button>
                  </div>
                </div>
                <div class="carousel-item banner-img4">
                  <div class="carousel-caption d-none d-md-block">
                    <h1>The perfect goal for your <br> health achivement</h1>
                    <p>Lorem ipsum dlior sit amet, consectetur adipis elit.<br>Consequatur natus repellendus facilis excepturi iste.</p>
                    <button type="button" class="btn btn-light text-primary ms-4">Book Now</button>
                </div>
              </div>
        ...
        <section class="sec2">
            <div class="s2row">
                ...
                <div class="s2right">
                    ...
                    <p class="para">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime ab dolorem repellat, quis adipisci repellendus facilis consectetur delectus quisquam culpa ut autem ullam earum. <br><br>
