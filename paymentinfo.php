...
<div class="container">
    <h2 class="text-center my-4">Select Disease and Package</h2>
    ...
    <form action="payment.php" method="POST">
        <div class="menu">
                ...
                <div class="col-12 text-center mt-2">
                        ...
                        <label>
                            <input type="checkbox" name="items[]" value="1" class="ms-4"> <!-- Use item ID for value -->
                        ...
                        <input type="number" id="amount" name="amount" step="0.01" min="0" placeholder="amount" class="text-secondary border border-5">
                </div>
                <!-- Item 2: Diabetes -->
                <div class="col-12 text-center mt-2">
